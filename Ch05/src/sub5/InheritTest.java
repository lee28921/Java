 ...
 *  - 공통적인 로직 내용을 부모클래스에 두고 자식클래스에서 상속받아 일관된 프로그래밍을 수행
...
class Child extends Parent { //자식 클래스
	...
	public Child(int num1,int num2, int num3, int num4) {//부모 클래스의 매개변수도 초기화
...
public class InheritTest {
	...
	public static void main(String[] args) {
		...
		int rs1 = c1.plus(); //부모 클래스 메서드
		int rs2 = c1.minus();//자식 클래스 메서드
